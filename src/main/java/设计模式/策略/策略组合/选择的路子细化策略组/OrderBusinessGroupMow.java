...
import 设计模式.策略.策略组合.实现策略.细化策略.OrderBusinessStartStation;
...
/**
 * @description:触屏业务分组--招行
 * @author: 范子祺
 **/
public class OrderBusinessGroupMow extends AbstractOrderBusinessGroup {
    @Override
    public List<OrderBusiness> getGroupBusiness() {
        ...
        businessList.add(new OrderBusinessStartStation());
